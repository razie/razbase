...
class MTest extends JUnit3Suite {
   ...
   def testL = expect (razie.MM("a")) { razie.M apply { val l = new java.util.ArrayList[String](); l.add("a"); l } }
   def testI = expect (razie.MM("a")) { razie.M apply { val l = new java.util.ArrayList[String](); l.add("a"); l }.iterator }
   ...
   def testL1 = expect (razie.MM("a")) { razie.M apply ala }
   def testL2 = expect (razie.MM("a")) { razie.M (ala) }
