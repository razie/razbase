...
public class SampleDrawable extends Drawable.Widget {
   ...
   public static class MyActionToInvoke extends BaseActionToInvoke {
      ...
      public MyActionToInvoke(String target, ActionItem item, Object... pairs) {
      ...
      public ActionToInvoke args(Object...args) {
         return new MyActionToInvoke (target, actionItem, args); 
      }
   }
    ...
    public Object render(Technology technology, DrawStream stream) {
        ...
        ActionToInvoke ATI = new MyActionToInvoke("", AI, "msg", "echo...");
